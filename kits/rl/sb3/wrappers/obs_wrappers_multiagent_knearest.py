...
class SimpleUnitObservationWrapper_multiagent_knearest(gym.ObservationWrapper):
    """
    ...
    def observation(self, obs):
        return SimpleUnitObservationWrapper_multiagent_knearest.convert_obs(obs, self.env.state.env_cfg)
